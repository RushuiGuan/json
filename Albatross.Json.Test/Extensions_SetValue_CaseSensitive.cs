...
namespace Albatross.Json.Test {
	public class Extensions_SetValue_CaseSensitive {
		...
		public static IEnumerable<object[]> SetValueTestData => new List<object[]> {
			...
			new object[] { """{"old":"data"}""", new[] { "Old" }, "data1", """{"old":"data", "Old":"data1"}""" },
			new object[] { """{"Parent":{"child":"old"}}""", new[] { "parent", "child" }, "new", """{"Parent":{"child":"old"}, "parent":{"child":"new"}}""" },
		};
